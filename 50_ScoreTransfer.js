...
8 points: "J", "X",
10 points: "Q", "Z",*/
function pointTransfer(word){
	var pointArr =  word.split("").map(x=>{return alphaScore[x]});
  return pointArr.reduce((accumulator,a)=> accumulator+a,0);
}
...
console.log(pointTransfer('store')); //3
